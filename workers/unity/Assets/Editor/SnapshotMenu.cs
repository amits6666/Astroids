...
namespace Assets.Editor
{
    ...
    public static class SnapshotMenu
    {
        ...
        [MenuItem("Improbable/Snapshots/Generate Spaceship Snapshot %#&w")]
        private static void GenerateSnapshotSpaceship()
        {
            var path = Application.dataPath + "/../../../snapshots/";
            var snapshot = new SnapshotBuilder("spaceship.snapshot", path);
            SnapshotSpaceship.Build(snapshot);
            snapshot.SaveSnapshot();
        }
